    ...
    <div className=" flex md:hidden">
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild>
          <button
            className="rounded-full w-[35px] h-[35px] inline-flex items-center justify-center text-green-500 bg-white shadow-[0_2px_10px] shadow-blackA7 outline-none hover:bg-violet3 focus:shadow-[0_0_0_2px] focus:shadow-black"
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            ...
            sideOffset={5}
          >
            <DropdownMenu.Item className="group text-[13px] leading-none text-green-700 rounded-[3px] flex items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none data-[highlighted]:bg-green-800 py-6 text-lg data-[highlighted]:text-violet1">
              <Link href="/">Home</Link>
            </DropdownMenu.Item>
