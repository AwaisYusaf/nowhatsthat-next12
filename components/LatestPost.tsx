...
function LatestPost({ post }: any) {
    return (
        <section className="mb-4 md:mb-0">
            ...
            <h1
                className="title font-semibold md:text-6xl text-2xl transition-all w-10/12 mt-6 hover:text-gray-600 text-black cursor-pointer leading-snug">The trick to getting more done is to have the freedom to roam around</h1>
